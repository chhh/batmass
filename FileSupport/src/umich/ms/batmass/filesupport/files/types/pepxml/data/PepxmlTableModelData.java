 ...
 */
public class PepxmlTableModelData extends FeatureTableModelData<PepxmlFeature> {

    public PepxmlTableModelData(DataSource<Features<PepxmlFeature>> source) {
        super(source);
    }

    @Override
    public TableModel create() {
        Features<PepxmlFeature> data = getData();
        if (data == null) {
        ...
        return new PepxmlTableModel(data.getMs1().getList());
    }
