...
public class MzrtTypeResolver extends AbstractFileTypeResolver {
    private static final MzrtTypeResolver INSTANCE = new MzrtTypeResolver();
    ...
    public static final String TYPE = "mzrt";
    protected static final String EXT = ".mzrt.csv";
    protected static final String DESCRIPTION = "CSV files with mzLo, mzHi, rtLo, rtHi columns";
    protected static final String SHORT_DESC = "m/z-rt csv";
    protected static final BMFileFilter FILE_FILTER = new BMSuffixFileFilter(EXT, SHORT_DESC, DESCRIPTION);
    
    public static MzrtTypeResolver getInstance() {
        return INSTANCE;
    }
