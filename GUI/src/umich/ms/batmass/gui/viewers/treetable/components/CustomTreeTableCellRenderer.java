 ...
 * the cells of an outline view. It uses the &lt;@link PropertyTextRenderer/&gt;
 * of the property if any was set.
 */
public class CustomTreeTableCellRenderer extends DefaultOutlineCellRenderer {
