...
public class NewProjectWizardPanel1 implements  WizardDescriptor.ValidatingPanel<WizardDescriptor> {
    public static final String PROP_PROJECT_FACTORY = "project_factory_type";
    ...
    public void storeSettings(WizardDescriptor wiz) {
        ...
        wiz.putProperty(PROP_PROJECT_FACTORY, getComponent().getListProjectTypes().getSelectedValue());
    }

    @Override
    public void validate() throws WizardValidationException {
        BMProjectFactory pf = component.getListProjectTypes().getSelectedValue();
        if (pf == null) {
            throw new WizardValidationException(null, "Select a type", null);
        }
    }
}
