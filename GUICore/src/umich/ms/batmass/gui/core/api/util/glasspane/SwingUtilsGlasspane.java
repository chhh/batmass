 ...
 * @author Darryl Burke
 */
public final class SwingUtilsGlasspane {

   private SwingUtilsGlasspane() {
   ...
   public static <T extends JComponent> List<T> getDescendantsOfType(
      ...
      for (Component component : container.getComponents()) {
         ...
         if (nested || !clazz.isAssignableFrom(component.getClass())) {
            tList.addAll(SwingUtilsGlasspane.<T>getDescendantsOfType(clazz,
   ...
   public static <T extends JComponent> List<T> getDescendantsOfClass(
      ...
      for (Component component : container.getComponents()) {
         ...
         if (nested || !clazz.equals(component.getClass())) {
            tList.addAll(SwingUtilsGlasspane.<T>getDescendantsOfClass(clazz,
                  (Container) component, nested));
         }
      }
      return tList;
