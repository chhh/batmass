 ...
 */
package umich.ms.batmass.gui.core.api.util.glasspane;
...
public class DisabledPanel extends JPanel {
    ...
    public static void disable(Container container) {
        List<JComponent> components
                = SwingUtilsGlasspane.getDescendantsOfType(JComponent.class, container, true);
    ...
    static class DisabledEventQueue extends EventQueue
        ...
        private Set<KeyStroke> getKeyStrokes(DisabledPanel panel) {
            ...
            List<JComponent> components = SwingUtilsGlasspane
                    .getDescendantsOfType(JComponent.class, container);
            ...
            for (JComponent component : components) {
                ...
                if (im != null && im.allKeys() != null) {
                    keyStrokes.addAll(Arrays.asList(im.allKeys()));
                }
            }
        ...
        public void windowClosed(WindowEvent e) {
            List<DisabledPanel> panelsToRemove = new ArrayList<>();
